...
public class Q02 {
    public static void main(String[] args) {
        ...
        //Print all key value pairs ==> My car is Honda and the year is 2021
        //hoca for loop kullanabilmek icin  Set e cevir dedi
        Set<Map.Entry<String,Integer>> setForm = map1.entrySet();//hocanin cozumu
        for(Map.Entry<String,Integer> w : setForm ) {
            System.out.println("My car is " + w.getKey() + " and the year is " + w.getValue());
        }

        for (String w : map1.keySet()){//benim cozumum
            System.out.println("my car is "+w+ " and its year is "+ map1.get(w));
        }
