...
public class HasTable01 {
    ...
    public static void main(String[] args) {
       ...
       // ht1.put(null,4500);//NullPointerException
        ...
        System.out.println(ht1.containsKey("Ali"));
        System.out.println(ht1.containsKey("Allkkjj"));
        System.out.println(ht1.contains(300));
        System.out.println(ht1.contains(100));
