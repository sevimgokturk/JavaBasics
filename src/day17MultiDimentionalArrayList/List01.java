...
public class List01 {
     ...
     */
        ...
        //Note: add() method puts the elements in ArrayList
        ...
        //How to check if an array list has only space in it
        ...
        // create an string arraylist add 5 elemts in to it and remove element whose length is  5
        List<String>al55=new ArrayList<String>();
        al55.add("a");
        al55.add("aa");
        al55.add("aaa");
        al55.add("aaaa");
        al55.add("aaaaa");
        al55.remove("aa");// true or false ===> true mission complated ======> mission failed
        for (int i=0;i<al55.size();i++){
            if (al55.get(i).length()<5){
                al55.remove(i);
